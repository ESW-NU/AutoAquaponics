...
AccelStepper stepper1(FULLSTEP, 1, 21, 3, 19); //this is the stepper for the auger
AccelStepper stepper2(FULLSTEP, 18, 17, 5, 16); //this is the stepper for the rack and pinion
int count=0;
int count2=0;
