...
def DataLogger():
    ...
    while True:
        ...
        last_distance, last_wtemp = np.round(logger.collect_data("SensorData", data_fxn, last_distance, last_wtemp, tsamp=1, nsamp=60),2) #change tsamp and nsamp for logging time/frequency
        logger.log_data()
        logger.commit()
