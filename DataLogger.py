...
param_list = ['v0 (mV)', 'v1 (mV)', 'v2 (mV)', 'v3 (mV)', 'v4 (mV)', 'v5 (mV)', 'v6 (mV)', 'v7 (mV)', 'v8 (mV)', 'v9 (mV)', 'v10 (mV)', 'v11 (mV)', 'v12 (mV)', 'v13 (mV)', 'v14 (mV)','p0 (uW)','p1 (uW)', 'p2 (uW)', 'p3 (uW)', 'p4 (uW)', 'p5 (uW)', 'p6 (uW)', 'p7 (uW)', 'p8 (uW)', 'p9 (uW)','p10 (uW)','p11 (uW)','p12 (uW)','p13 (uW)','p14 (uW)','Soil Temp (\N{DEGREE SIGN}C)', 'Soil Moisture (%)', 'Water Level (cm)']
all_we_got_now = ('unix_time', 'v0', 'v1', 'v2', 'v3', 'v4', 'v5', 'v6', 'v7', 'v8', 'v9', 'v10', 'v11', 'v12', 'v13', 'v14', 'p0','p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p10', 'p11', 'p12', 'p13', 'p14', 'soil_temp', 'soil_moisture', 'water_level')
now_data_types = ("datetime", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float")
