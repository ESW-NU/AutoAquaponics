...
class ControlPanel(tk.Frame):
    ...
    #Save button
        ...
        saveButton.grid(row=2, columnspan=14)
    ...
    #Entry widgets for Channel OverWrite Times
        #Labels for each:
        tk.Label(self, text="Turn on for:").grid(row=3, column=3)
        tk.Label(self, text="Turn on for:").grid(row=4, column=3)
        tk.Label(self, text="Turn on for:").grid(row=5, column=3)
        tk.Label(self, text="Turn on for:").grid(row=6, column=3)
        tk.Label(self, text="Turn on for:").grid(row=7, column=3)
        tk.Label(self, text="Turn on for:").grid(row=8, column=3)
        tk.Label(self, text="Turn on for:").grid(row=9, column=3)
        tk.Label(self, text="Turn on for:").grid(row=10, column=3)
        tk.Label(self, text="Turn on for:").grid(row=3, column=9)
        tk.Label(self, text="Turn on for:").grid(row=4, column=9)
        tk.Label(self, text="Turn on for:").grid(row=5, column=9)
        tk.Label(self, text="Turn on for:").grid(row=6, column=9)
        tk.Label(self, text="Turn on for:").grid(row=7, column=9)
        tk.Label(self, text="Turn on for:").grid(row=8, column=9)
        tk.Label(self, text="Turn on for:").grid(row=9, column=9)
        tk.Label(self, text="Turn on for:").grid(row=10, column=9)

        tk.Label(self, text="Turn off for:").grid(row=3, column=5)
        tk.Label(self, text="Turn off for:").grid(row=4, column=5)
        tk.Label(self, text="Turn off for:").grid(row=5, column=5)
        tk.Label(self, text="Turn off for:").grid(row=6, column=5)
        tk.Label(self, text="Turn off for:").grid(row=7, column=5)
        tk.Label(self, text="Turn off for:").grid(row=8, column=5)
        tk.Label(self, text="Turn off for:").grid(row=9, column=5)
        tk.Label(self, text="Turn off for:").grid(row=10, column=5)
        tk.Label(self, text="Turn off for:").grid(row=3, column=11)
        tk.Label(self, text="Turn off for:").grid(row=4, column=11)
        tk.Label(self, text="Turn off for:").grid(row=5, column=11)
        tk.Label(self, text="Turn off for:").grid(row=6, column=11)
        tk.Label(self, text="Turn off for:").grid(row=7, column=11)
        tk.Label(self, text="Turn off for:").grid(row=8, column=11)
        tk.Label(self, text="Turn off for:").grid(row=9, column=11)
        tk.Label(self, text="Turn off for:").grid(row=10, column=11)
