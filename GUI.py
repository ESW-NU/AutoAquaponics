...
config_path = os.path.expanduser("~/Desktop/config.csv")
...
class Settings(tk.Frame):
    def __init__(self, parent, controller):
        ...
        pH_lower = DoubleVar()
        pH_upper = DoubleVar()
        self.pH_lower_label = tk.Label(self, text="Min pH:", bg='white')
        self.pH_lower_entry = tk.Entry(self, textvariable = pH_lower)
        self.pH_upper_label = tk.Label(self, text="Max pH:", bg='white')
        self.pH_upper_entry = tk.Entry(self, textvariable = pH_upper)
        self.pH_lower_label.place(x=1,y=150)
        self.pH_lower_entry.place(x=175,y=150)
        self.pH_upper_label.place(x=375,y=150)
        self.pH_upper_entry.place(x=550,y=150)
        # TDS widget
        TDS_lower = DoubleVar()
        TDS_upper = DoubleVar()
        self.TDS_lower_label = Label(self,text="Min TDS (ppm):",bg='white')
        self.TDS_lower_entry = Entry(self,textvariable = TDS_lower)
        self.TDS_upper_label = Label(self,text="Max TDS (ppm):",bg='white')
        self.TDS_upper_entry = Entry(self,textvariable = TDS_upper)
        self.TDS_lower_label.place(x=1,y=175)
        self.TDS_lower_entry.place(x=175,y=175)
        self.TDS_upper_label.place(x=375,y=175)
        self.TDS_upper_entry.place(x=550,y=175)
        # DO widget
        DO_lower = DoubleVar()
        DO_upper = DoubleVar()
        self.DO_lower_label = Label(self,text="Min DO (ppm):",bg='white')
        self.DO_lower_entry = Entry(self,textvariable = DO_lower)
        self.DO_upper_label = Label(self,text="Max DO (ppm):",bg='white')
        self.DO_upper_entry = Entry(self,textvariable = DO_upper)
        self.DO_lower_label.place(x=1,y=200)
        self.DO_lower_entry.place(x=175,y=200)
        self.DO_upper_label.place(x=375,y=200)
        self.DO_upper_entry.place(x=550,y=200)
        # Phosphate widget
        Phosphate_lower = DoubleVar()
        Phosphate_upper = DoubleVar()
        self.Phosphate_lower_label = Label(self,text="Min Phosphate (ppm):",bg='white')
        self.Phosphate_lower_entry = Entry(self,textvariable = Phosphate_lower)
        self.Phosphate_upper_label = Label(self,text="Max Phosphate (ppm):",bg='white')
        self.Phosphate_upper_entry = Entry(self,textvariable = Phosphate_upper)
        self.Phosphate_lower_label.place(x=1,y=225)
        self.Phosphate_lower_entry.place(x=175,y=225)
        self.Phosphate_upper_label.place(x=375,y=225)
        self.Phosphate_upper_entry.place(x=550,y=225)
        
        # Nitrate widget
        Nitrate_lower = DoubleVar()
        Nitrate_upper = DoubleVar()
        self.Nitrate_lower_label = Label(self,text="Min Nitrate (ppm):",bg='white')
        self.Nitrate_lower_entry = Entry(self,textvariable = Nitrate_lower)
        self.Nitrate_upper_label = Label(self,text="Max Nitrate (ppm):",bg='white')
        self.Nitrate_upper_entry = Entry(self,textvariable = Nitrate_upper)
        self.Nitrate_lower_label.place(x=1,y=250)
        self.Nitrate_lower_entry.place(x=175,y=250)
        self.Nitrate_upper_label.place(x=375,y=250)
        self.Nitrate_upper_entry.place(x=550,y=250)
        # Ammonia widget
        Ammonia_lower = DoubleVar()
        Ammonia_upper = DoubleVar()
        self.Ammonia_lower_label = Label(self,text="Min Ammonia (ppm):",bg='white')
        self.Ammonia_lower_entry = Entry(self,textvariable = Ammonia_lower)
        self.Ammonia_upper_label = Label(self,text="Max Ammonia (ppm):",bg='white')
        self.Ammonia_upper_entry = Entry(self,textvariable = Ammonia_upper)
        self.Ammonia_lower_label.place(x=1,y=275)
        self.Ammonia_lower_entry.place(x=175,y=275)
        self.Ammonia_upper_label.place(x=375,y=275)
        self.Ammonia_upper_entry.place(x=550,y=275)
        # Air Temperature widget
        Air_Temperature_lower = DoubleVar()
        Air_Temperature_upper = DoubleVar()
        self.Air_Temperature_lower_label = Label(self,text="Min Air Temp (Celsius):",bg='white')
        self.Air_Temperature_lower_entry = Entry(self,textvariable = Air_Temperature_lower)
        self.Air_Temperature_upper_label = Label(self,text="Max Air Temp (Celsius):",bg='white')
        self.Air_Temperature_upper_entry = Entry(self,textvariable = Air_Temperature_upper)
        self.Air_Temperature_lower_label.place(x=1,y=300)
        self.Air_Temperature_lower_entry.place(x=175,y=300)
        self.Air_Temperature_upper_label.place(x=375,y=300)
        self.Air_Temperature_upper_entry.place(x=550,y=300)
        # Air Humidity widget
        Air_Humidity_lower = DoubleVar()
        Air_Humidity_upper = DoubleVar()
        self.Air_Humidity_lower_label = Label(self,text="Min Air Humidity (ppm):",bg='white')
        self.Air_Humidity_lower_entry = Entry(self,textvariable = Air_Humidity_lower)
        self.Air_Humidity_upper_label = Label(self,text="Max Air Humidity (ppm):",bg='white')
        self.Air_Humidity_upper_entry = Entry(self,textvariable = Air_Humidity_upper)
        self.Air_Humidity_lower_label.place(x=1,y=325)
        self.Air_Humidity_lower_entry.place(x=175,y=325)
        self.Air_Humidity_upper_label.place(x=375,y=325)
        self.Air_Humidity_upper_entry.place(x=550,y=325)
        ...
        self.Water_Temperature_lower_label.place(x=1,y=350)
        self.Water_Temperature_lower_entry.place(x=175,y=350)
        self.Water_Temperature_upper_label.place(x=375,y=350)
        self.Water_Temperature_upper_entry.place(x=550,y=350)
        # Water Level widget
        Water_Level_lower = DoubleVar()
        Water_Level_upper = DoubleVar()
        self.Water_Level_lower_label = Label(self,text="Min Water Level (inches):",bg='white')
        self.Water_Level_lower_entry = Entry(self,textvariable = Water_Level_lower)
        self.Water_Level_upper_label = Label(self,text="Max Water Level (inches):",bg='white')
        self.Water_Level_upper_entry = Entry(self,textvariable = Water_Level_upper) 
        self.Water_Level_lower_label.place(x=1,y=375)
        self.Water_Level_lower_entry.place(x=175,y=375)
        self.Water_Level_upper_label.place(x=375,y=375)
        self.Water_Level_upper_entry.place(x=550,y=375)
        # Flow Rate widget
        Flow_Rate_lower = DoubleVar()
        Flow_Rate_upper = DoubleVar()
        self.Flow_Rate_lower_label = Label(self,text="Min Flow Rate (GPH):",bg='white')
        self.Flow_Rate_lower_entry = Entry(self,textvariable = Flow_Rate_lower)
        self.Flow_Rate_upper_label = Label(self,text="Max Flow Rate (GPH):",bg='white')
        self.Flow_Rate_upper_entry = Entry(self,textvariable = Flow_Rate_upper) 
        self.Flow_Rate_lower_label.place(x=1,y=400)
        self.Flow_Rate_lower_entry.place(x=175,y=400)
        self.Flow_Rate_upper_label.place(x=375,y=400)
        self.Flow_Rate_upper_entry.place(x=550,y=400)
    ...
    # Save Button 
        ...
        navibutton3 = ttk.Button(self, text="Save",
                            command=save_Entry_Widget())
        navibutton3.pack()
        navibutton4 = ttk.Button(self, text="Discard")
        navibutton4.pack()
