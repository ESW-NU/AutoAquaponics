...
class Settings(tk.Frame):
    def __init__(self, parent, controller):
        ...
        pH_lower = DoubleVar()
        pH_upper = DoubleVar()
        self.pH_lower_label = Label(self,bg = 'white', width = 25, anchor = 'e', text="Min pH:")
        self.pH_lower_entry = Entry(self, width = 20, textvariable = pH_lower)
        self.pH_upper_label = Label(self,bg = 'white', width = 25, anchor = 'e', text="Max pH:")
        self.pH_upper_entry = Entry(self, width = 20, textvariable = pH_upper)
        ...
        TDS_lower = DoubleVar()
        TDS_upper = DoubleVar()
        self.TDS_lower_label = Label(self,bg = 'white', width = 25,anchor = 'e',text="Min TDS (ppm):")
        self.TDS_lower_entry = Entry(self, width = 20, textvariable = TDS_lower)
        self.TDS_upper_label = Label(self,bg = 'white', width = 25,anchor = 'e',text="Max TDS (ppm):")
        self.TDS_upper_entry = Entry(self, width = 20, textvariable = TDS_upper)
        ...
        DO_lower = DoubleVar()
        DO_upper = DoubleVar()
        self.DO_lower_label = Label(self,bg = 'white', width = 25,anchor = 'e',text="Min DO (ppm):")
        self.DO_lower_entry = Entry(self, width = 20, textvariable = DO_lower)
        self.DO_upper_label = Label(self,bg = 'white', width = 25,anchor = 'e',text="Max DO (ppm):")
        self.DO_upper_entry = Entry(self, width = 20, textvariable = DO_upper)
        ...
        self.Phosphate_lower_label = Label(self,bg = 'white', width = 25,anchor = 'e',text="Min Phosphate (ppm):")
        self.Phosphate_lower_entry = Entry(self, width = 20, textvariable = Phosphate_lower)
        self.Phosphate_upper_label = Label(self,bg = 'white', width = 25,anchor = 'e',text="Max Phosphate (ppm):")
        self.Phosphate_upper_entry = Entry(self, width = 20, textvariable = Phosphate_upper)
        ...
        self.Nitrate_lower_label = Label(self,bg = 'white', width = 25,anchor = 'e',text="Min Nitrate (ppm):")
        self.Nitrate_lower_entry = Entry(self, width = 20, textvariable = Nitrate_lower)
        self.Nitrate_upper_label = Label(self,bg = 'white', width = 25,anchor = 'e',text="Max Nitrate (ppm):")
        self.Nitrate_upper_entry = Entry(self, width = 20, textvariable = Nitrate_upper)
        ...
        self.Ammonia_lower_label = Label(self,bg = 'white', width = 25,anchor = 'e',text="Min Ammonia (ppm):")
        self.Ammonia_lower_entry = Entry(self, width = 20, textvariable = Ammonia_lower)
        self.Ammonia_upper_label = Label(self,bg = 'white', width = 25,anchor = 'e',text="Max Ammonia (ppm):")
        self.Ammonia_upper_entry = Entry(self, width = 20, textvariable = Ammonia_upper)
        ...
        self.Air_Temperature_lower_label = Label(self, bg = 'white', width = 25,anchor = 'e', text="Min Air Temperature (Celsius):")
        self.Air_Temperature_lower_entry = Entry(self, width = 20, textvariable = Air_Temperature_lower)
        self.Air_Temperature_upper_label = Label(self, bg = 'white', width = 25,anchor = 'e', text="Max Air Temperature (Celsius):")
        self.Air_Temperature_upper_entry = Entry(self, width = 20, textvariable = Air_Temperature_upper)
        ...
        self.Air_Humidity_lower_label = Label(self,bg = 'white', width = 25,anchor = 'e', text="Min Air Humidity (%):")
        self.Air_Humidity_lower_entry = Entry(self, width = 20, textvariable = Air_Humidity_lower)
        self.Air_Humidity_upper_label = Label(self,bg = 'white', width = 25,anchor = 'e', text="Max Air Humidity (%):")
        self.Air_Humidity_upper_entry = Entry(self, width = 20, textvariable = Air_Humidity_upper)
        ...
        self.Water_Temperature_lower_label = Label(self,bg = 'white', width = 25,anchor = 'e', text="Min Water Temperature (Celsius):")
        self.Water_Temperature_lower_entry = Entry(self, width = 20, textvariable = Water_Temperature_lower)
        self.Water_Temperature_upper_label = Label(self,bg = 'white', width = 25,anchor = 'e', text="Max Water Temperature (Celsius):")
        self.Water_Temperature_upper_entry = Entry(self, width = 20, textvariable = Water_Temperature_upper)
        ...
        self.Water_Level_lower_label = Label(self,bg = 'white', width = 25,anchor = 'e', text="Min Water Level (inches):")
        self.Water_Level_lower_entry = Entry(self, width = 20, textvariable = Water_Level_lower)
        self.Water_Level_upper_label = Label(self,bg = 'white', width = 25,anchor = 'e', text="Max Water Level (inches):")
        self.Water_Level_upper_entry = Entry(self, width = 20, textvariable = Water_Level_upper) 
        ...
        self.Flow_Rate_lower_label = Label(self,bg = 'white', width = 25,anchor = 'e', text="Min Flow Rate (GPH):")
        self.Flow_Rate_lower_entry = Entry(self, width = 20, textvariable = Flow_Rate_lower)
        self.Flow_Rate_upper_label = Label(self,bg = 'white', width = 25,anchor = 'e', text="Max Flow Rate (GPH):")
        self.Flow_Rate_upper_entry = Entry(self, width = 20, textvariable = Flow_Rate_upper) 
