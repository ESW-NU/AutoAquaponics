...
class Settings(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.pH_lower_label.place(x=151,y=150)
        self.pH_lower_entry.place(x=325,y=150)
        self.pH_upper_label.place(x=525,y=150)
        self.pH_upper_entry.place(x=700,y=150)
        # TDS widget
        TDS_lower = DoubleVar()
        TDS_upper = DoubleVar()
        ...
        self.TDS_lower_label.place(x=151,y=175)
        self.TDS_lower_entry.place(x=325,y=175)
        self.TDS_upper_label.place(x=525,y=175)
        self.TDS_upper_entry.place(x=700,y=175)
        # DO widget
        DO_lower = DoubleVar()
        DO_upper = DoubleVar()
        ...
        self.DO_lower_label.place(x=151,y=200)
        self.DO_lower_entry.place(x=325,y=200)
        self.DO_upper_label.place(x=525,y=200)
        self.DO_upper_entry.place(x=700,y=200)
        # Phosphate widget
        ...
        self.Phosphate_lower_label.place(x=151,y=225)
        self.Phosphate_lower_entry.place(x=325,y=225)
        self.Phosphate_upper_label.place(x=525,y=225)
        self.Phosphate_upper_entry.place(x=700,y=225)
        ...
        self.Nitrate_lower_label.place(x=151,y=250)
        self.Nitrate_lower_entry.place(x=325,y=250)
        self.Nitrate_upper_label.place(x=525,y=250)
        self.Nitrate_upper_entry.place(x=700,y=250)
        # Ammonia widget
        ...
        self.Ammonia_lower_label.place(x=151,y=275)
        self.Ammonia_lower_entry.place(x=325,y=275)
        self.Ammonia_upper_label.place(x=525,y=275)
        self.Ammonia_upper_entry.place(x=700,y=275)
        ...
        self.Air_Temperature_lower_label.place(x=151,y=300)
        self.Air_Temperature_lower_entry.place(x=325,y=300)
        self.Air_Temperature_upper_label.place(x=525,y=300)
        self.Air_Temperature_upper_entry.place(x=700,y=300)
        # Air Humidity widget
        ...
        self.Air_Humidity_lower_label.place(x=151,y=325)
        self.Air_Humidity_lower_entry.place(x=325,y=325)
        self.Air_Humidity_upper_label.place(x=525,y=325)
        self.Air_Humidity_upper_entry.place(x=700,y=325)
        ...
        self.Water_Temperature_upper_label.place(x=525,y=350)
        self.Water_Temperature_upper_entry.place(x=700,y=350)
        # Water Level widget
        ...
        self.Water_Level_lower_label.place(x=151,y=375)
        self.Water_Level_lower_entry.place(x=325,y=375)
        self.Water_Level_upper_label.place(x=525,y=375)
        self.Water_Level_upper_entry.place(x=700,y=375)
        # Flow Rate widget
        ...
        self.Flow_Rate_lower_label.place(x=151,y=400)
        self.Flow_Rate_lower_entry.place(x=325,y=400)
        self.Flow_Rate_upper_label.place(x=525,y=400)
        self.Flow_Rate_upper_entry.place(x=700,y=400)
